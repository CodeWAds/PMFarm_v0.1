...
class Ui_PMFarm(object):
    ...
    def make_dialog(self):
        ...
        lbl = QtWidgets.QLabel('Введено некорректное значение', dlg)
    ...
    def retranslateUi(self, PMFarm):
        ...
        self.button_start.setText(_translate("PMFarm", "СТАРТ"))
        self.button_exit.setText(_translate("PMFarm", "Экстренное завершение программы"))
        self.label_1.setText(_translate("PMFarm", "Пожалуйста, выберите длину теплицы,"))
        self.label_2.setText(_translate("PMFarm", "затем нажмите \"старт\"."))
        self.label.setText(_translate("PMFarm", "ДЛИНА"))
